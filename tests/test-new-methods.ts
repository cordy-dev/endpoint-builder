...
import { ApiKeyStrategy, OpaqueTokenStrategy } from "../src/auth/index";
import { MemoryStoragePersist } from "../src/storage/index";
...
async function testNewMethodNames() {
	...
	// Test handleRequestError method
